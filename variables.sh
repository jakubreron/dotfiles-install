...
declare -xr DI_NVIM_REPO="git@github.com:jakubreron/kickstart.nvim.git"

declare -xr DI_VOIDRICE_DIR="$DI_DOTFILES_DIR/voidrice"
declare -xr DI_VOIDRICE_REPO="git@github.com:jakubreron/voidrice.git"

declare -xr DI_MACOS_DIR="$DI_DOTFILES_DIR/macos"
declare -xr DI_MACOS_REPO="git@github.com:jakubreron/macos.git"

declare -xr DI_PKGLISTS_DIR="$DI_DOTFILES_DIR/pkglists"
declare -xr DI_PKGLISTS_REPO="git@github.com:jakubreron/pkglists.git"

declare -xr DI_UNIVERSAL_DIR="$DI_DOTFILES_DIR/universal"
declare -xr DI_UNVIERSAL_REPO="git@github.com:jakubreron/universal.git"
